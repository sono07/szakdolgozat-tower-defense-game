...
import { TURRET_ENERGY_BALL_ORANGE_MK3_COST } from "../../../impl/game-config";
import { TILE_TURRET_ENERGY_BALL_ORANGE_MK3 } from "../../../impl/game-constants";
...
import { TurretEnergyBallOrangeMk3Object } from "../../../impl/object/turret/turret-energy-ball-orange-mk3.object.class";
...
test('Turret energy ball orange mk3 group construct', () => {
    baseTurretGroupMockHelper.setup((proto) => {
    })

    const sceneMock = jest.fn<Phaser.Scene, any[]>((...args: any[]) => ({} as any))();
    const group = new TurretEnergyBallOrangeMk3Group(sceneMock);
