...
import { TURRET_ROCKET_MK1_FIRERATE, TURRET_ROCKET_MK1_RANGE } from "../../utils/config.constants";
...
export class TurretRocketMk1Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_ROCKET_MK1_RANGE;
    private firerate: number = TURRET_ROCKET_MK1_FIRERATE;
    ...
    constructor(scene: Phaser.Scene) {
        super(scene, 'turret-weapons', 'rocket-mk1');
        this.setScale(0.75)
        this.setDepth(6);
