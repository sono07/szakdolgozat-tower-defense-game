...
import { TURRET_ROCKET_MK2_EFFECTS, TURRET_ROCKET_MK2_FIRERATE, TURRET_ROCKET_MK2_RANGE } from "../../utils/config.constants";
...
export class TurretRocketMk2Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_ROCKET_MK2_RANGE;
    private firerate: number = TURRET_ROCKET_MK2_FIRERATE;
    ...
    constructor(scene: Phaser.Scene) {
        super(scene, 'turret-weapons', 'rocket-mk2');
        this.setScale(0.75)
    ...
    private addProjectile(enemy: IEnemy, angle: number) {
        ...
        if (rocket) {
            ...
            rocket.init({
                ...
                speed: 100,
                effects: TURRET_ROCKET_MK2_EFFECTS,
