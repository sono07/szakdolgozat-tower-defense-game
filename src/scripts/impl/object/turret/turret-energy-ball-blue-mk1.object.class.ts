...
import { TURRET_ENERGY_BALL_BLUE_MK1_EFFECTS, TURRET_ENERGY_BALL_BLUE_MK1_FIRERATE, TURRET_ENERGY_BALL_BLUE_MK1_RANGE } from "../../utils/config.constants";
...
export class TurretEnergyBallBlueMk1Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_ENERGY_BALL_BLUE_MK1_RANGE;
    private firerate: number = TURRET_ENERGY_BALL_BLUE_MK1_FIRERATE;
    ...
    private addProjectile(enemy: IEnemy, angle: number) {
        ...
        if (energyBallBlue) {
            ...
            energyBallBlue.init({
                ...
                speed: 400,
                effects: TURRET_ENERGY_BALL_BLUE_MK1_EFFECTS,
