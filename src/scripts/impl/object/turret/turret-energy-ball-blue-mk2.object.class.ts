...
import { TURRET_ENERGY_BALL_BLUE_MK2_EFFECTS, TURRET_ENERGY_BALL_BLUE_MK2_FIRERATE, TURRET_ENERGY_BALL_BLUE_MK2_RANGE } from "../../utils/config.constants";
...
export class TurretEnergyBallBlueMk2Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_ENERGY_BALL_BLUE_MK2_RANGE;
    private firerate: number = TURRET_ENERGY_BALL_BLUE_MK2_FIRERATE;
    private baseImage!: Phaser.GameObjects.Image;
    private rangeCircle!: Phaser.GameObjects.Arc;

    constructor(scene: Phaser.Scene) {
        super(scene, 'turret-weapons', 'energy-ball-blue-mk2');
        this.setScale(0.75)
    ...
    private addProjectile(enemy: IEnemy, angle: number) {
        ...
        if (energyBallBlue) {
            ...
            energyBallBlue.init({
                ...
                speed: 400,
                effects: TURRET_ENERGY_BALL_BLUE_MK2_EFFECTS,
