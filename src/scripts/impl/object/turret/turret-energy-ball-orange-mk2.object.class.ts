...
import { TURRET_ENERGY_BALL_ORANGE_MK2_EFFECTS, TURRET_ENERGY_BALL_ORANGE_MK2_FIRERATE, TURRET_ENERGY_BALL_ORANGE_MK2_RANGE } from "../../utils/config.constants";
    ...
    private addProjectile(enemy: IEnemy, angle: number) {
        ...
        if (energyBallOrange) {
            ...
            energyBallOrange.init({
                ...
                speed: 400,
                effects: TURRET_ENERGY_BALL_ORANGE_MK2_EFFECTS,
