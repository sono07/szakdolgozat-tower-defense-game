...
import { TURRET_LASER_MK2_FIRERATE, TURRET_LASER_MK2_RANGE } from "../../utils/config.constants";
...
export class TurretLaserMk2Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_LASER_MK2_RANGE;
    private firerate: number = TURRET_LASER_MK2_FIRERATE;
    private baseImage!: Phaser.GameObjects.Image;
    private rangeCircle!: Phaser.GameObjects.Arc;

    constructor(scene: Phaser.Scene) {
        super(scene, 'turret-weapons', 'laser-mk2');
        this.setScale(0.75)
        this.setDepth(6);
