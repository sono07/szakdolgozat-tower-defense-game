...
import { TURRET_ENERGY_BALL_BLUE_MK3_FIRERATE, TURRET_ENERGY_BALL_BLUE_MK3_RANGE } from "../../utils/config.constants";
...
export class TurretEnergyBallBlueMk3Object extends BaseTurretObject {
    ...
    private radius: number = TURRET_ENERGY_BALL_BLUE_MK3_RANGE;
    private firerate: number = TURRET_ENERGY_BALL_BLUE_MK3_FIRERATE;
