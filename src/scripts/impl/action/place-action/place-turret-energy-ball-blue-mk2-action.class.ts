...
import { ACTION_KEY_PLACE_TURRET_ENERGY_BALL_BLUE_MK2 } from "../../utils/constants";
import { PlaceAction } from "./_abstract/place-action.abstract";

export class PlaceTurretEnergyBallBlueMk2Action extends PlaceAction implements IAction {
    ...
    constructor(gameStateStore: IGameStateStore) {
        ...
        this.group = gameStateStore.turretEnergyBallBlueMk2sGroup as any;
    }
}
